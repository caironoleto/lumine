...
//$op='S';//DEBUG
    ...
    //Check whether we are going to outline text or not
		if(isset($this->outline_on) && $this->outline_on)
		{
    ...
    $adjusty = 0;
    if(isset($this->SUB) && $this->SUB) $adjusty = 1;
    if(isset($this->SUP) && $this->SUP) $adjusty = -1;
    ...
    $adjusty = 1.6;
    if(isset($this->SUB) && $this->SUB) $adjusty = 3.05;
    if(isset($this->SUP) && $this->SUP) $adjusty = 1.1;
    //End of coordinate adjustment
		if(isset($this->strike) && $this->strike) //EDITEI
	...
	for($n=1;$n<=$nb;$n++)
	{
		...
		if(isset($this->PageLinks[$n]))
		{
			...
			foreach($this->PageLinks[$n] as $pl)
			{
				...
				{
					$l= isset($this->links[$pl[4]]) ? $this->links[$pl[4]] : 0;
