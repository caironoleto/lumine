...
/**
 * Classe para geraзгo de relatуrios
...
class Lumine_Report extends Lumine_EventListener
{
	...
	/**
	 * Formatos de arquivos disponнveis
	 */
	 ...
	 * @param Lumine_Base $obj Objeto a ser gerado o relatуrio
	...
	function addColumn( $prop )
	{
		...
		{
			throw new Exception('Formato de coluna invбlida. Vocк deve informar as propriedades "name","header" e "width"');
		}
	...
	function setColumns( $arrayColumns )
	{
		...
		try {
			...
			Lumine_Log::warning('Formato de coluna invбlido, restaurando anterior...');
			$this->columns = $old;
		}
	}
	...
	public function setFormat( $fm )
	{
		...
		{
			throw new Exception('Formato nгo suportado: '.$fm);
		}
		$this->format = $fm;
	}
