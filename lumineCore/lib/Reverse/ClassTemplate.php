...
/**
 * Classe para gerar as entidades atravщs da engenharia reversa
 *
...
class Lumine_Reverse_ClassTemplate 
{
    ...
    /**
     * Utilizar ou nуo CamelCase nos nomes das propriedades
     *
     * @var unknown_type
     */
