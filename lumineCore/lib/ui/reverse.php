...
$options = array('schema_name','generate_files','generate_zip','class_sufix','remove_count_chars_start','remove_count_chars_end','remove_prefix','create_entities_for_many_to_many','plural','create_entities_for_many_to_many','many_to_many_style','create_controls','camel_case');
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
	<table width="100%" border="0" cellspacing="1" cellpadding="2">
		...
		<tr>
		  <td align="right">Usar CamelCase nos nomes dos membros da classe?</td>
		  <td><select name="camel_case" id="camel_case">
            <option value="0"<?php echo $_POST['camel_case']=='0'?' selected="selected"' : ''; ?>>N&atilde;o</option>
            <option value="1"<?php echo $_POST['camel_case']=='1'?' selected="selected"' : ''; ?>>Sim</option>
          </select></td>
	  </tr>
		<tr>
		...
		<tr>
		  <td align="right">Manter nomes das colunas nas chaves estrangeiras?</td>
		  <td><select name="keep_foreign_column_name" id="keep_foreign_column_name">
		    <option value="0">n&atilde;o</option>
		    <option value="1" <?php echo !empty($_POST['keep_foreign_column_name']) ? ' selected="selected"' : ''; ?>>sim</option>
		    </select>		  </td>
	  </tr>
		<tr>
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
	...
	<tr>
		...
		try
		{
			...
			$_POST['options']['keep_foreign_column_name'] = $_POST['keep_foreign_column_name'] == 1 ? true : false;
